"""
Módulo Pontuação - Camada de Dados (Model)

Este módulo contém a classe Pontuacao, que armazena os dados
de pontuação e vidas do jogador. Esta classe:
- Armazena apenas DADOS (pontos e vidas)
- NÃO contém regras de negócio (delegadas para PontuacaoBusiness)

Princípios de POO aplicados:
1. ENCAPSULAMENTO: Dados protegidos com validação nos setters
2. SEPARAÇÃO DE RESPONSABILIDADES: Dados aqui, lógica em Business/
3. MÉTODOS ESPECIAIS: __str__ e __eq__ para debug e comparação
"""
