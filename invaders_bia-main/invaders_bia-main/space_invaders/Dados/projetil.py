"""
Módulo Projetil - Camada de Dados (Model)

Este módulo contém a classe Projetil, que representa os tiros
disparados pelo jogador ou pelos inimigos. Características:
- Posição e dimensões do projétil
- Identificação se é projétil do jogador ou inimigo
- Cor de fallback quando não há sprite disponível

Princípios de POO aplicados:
1. ENCAPSULAMENTO: Dados protegidos por atributos privados
2. POLIMORFISMO IMPLÍCITO: Mesmo tipo trata projéteis do jogador e inimigo
3. PROPERTIES: Controle de acesso aos dados
"""
...
class Projetil:
    ...
    @property
    def sprite(self):
        """Getter para o sprite do projétil (pode ser None)."""
