"""
Módulo Jogador - Camada de Dados (Model)

Este módulo contém a classe Jogador, que representa a entidade
do jogador (nave espacial) no jogo. Segue o padrão de separação
de responsabilidades:

- Camada de DADOS: Define atributos e propriedades (este arquivo)
- Camada de NEGÓCIO: Define regras de comportamento (jogador_business.py)

Princípios de POO aplicados:
1. ENCAPSULAMENTO: Atributos privados com __ (double underscore)
2. PROPERTIES: Getters e setters controlados com validação
3. PROTEÇÃO DE DADOS: Retorna cópias de listas para evitar modificação externa
"""
...
class Jogador:
    ...
    @property
    def sprite(self):
        """Getter para o sprite do jogador (pode ser None)."""
        return self.__sprite

    @sprite.setter
    def sprite(self, surface):
        """Setter para sprite (aceita qualquer Surface compatível ou None)."""
