"""
Módulo Jogo - Orquestrador Principal com Interface Gráfica (Pygame)

Este módulo contém as classes responsáveis pela execução do jogo
com interface gráfica usando a biblioteca Pygame.

Classes:
- Menu: Gerencia a tela inicial do jogo
- GameOver: Gerencia a tela de fim de jogo  
- Jogo: Classe principal que orquestra todos os componentes

Padrões Utilizados:
- COMPOSIÇÃO: Jogo contém instâncias de Jogador, Inimigos, etc.
- DELEGAÇÃO: Lógica delegada para classes Business
- GAME LOOP: Ciclo processar_eventos -> atualizar -> desenhar
- SEPARAÇÃO MVC: Renderização aqui, lógica em Business/, dados em Dados/

Para executar: python -m space_invaders.desktop
"""
