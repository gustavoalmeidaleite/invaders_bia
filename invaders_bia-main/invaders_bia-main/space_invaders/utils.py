"""
Módulo de Utilitários - Space Invaders

Este módulo centraliza todas as constantes e classes auxiliares do jogo.
Contém:
- Configurações de tela (dimensões, cores)
- Velocidades dos elementos do jogo
- Estados do jogo (menu, jogando, game over)
- Classe EfeitoExplosao para efeitos visuais
- Função de carregamento de sprites

Princípio de POO: Centralização de constantes evita "magic numbers"
dispersos pelo código, facilitando manutenção e ajustes.
"""
...
# =============================================================================
# CONSTANTES DE TELA E DIMENSÕES
# =============================================================================
LARGURA_TELA = 800
ALTURA_TELA = 600
...
# =============================================================================
# CORES PARA INTERFACE DE USUÁRIO (Menus, HUD, etc.)
# =============================================================================
COR_TEXTO = (255, 255, 255)  # Branco - texto padrão
COR_TEXTO_SELECIONADO = (255, 255, 0)  # Amarelo - opção selecionada em menus
COR_TITULO = (0, 255, 255)  # Ciano - títulos e destaques

# =============================================================================
# ESTADOS DO JOGO (Máquina de Estados Finitos)
# Define os possíveis estados que o jogo pode estar
# =============================================================================
ESTADO_MENU = 0       # Tela inicial com opções
ESTADO_JOGANDO = 1    # Partida em andamento
ESTADO_GAME_OVER = 2  # Tela de fim de jogo
