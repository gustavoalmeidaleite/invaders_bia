...
from barreira_business import BarreiraBusiness
...
class Jogo:
    ...
    def inicializar_jogo(self):
        ...
        self.barreiras = [Barreira(150 + i*150, 450) for i in range(4)]
        self.barreira_business = BarreiraBusiness(self.barreiras)
    ...
    def verificar_colisoes(self):
        ...
        self.projetil_business.verificar_colisoes_com_objetos(self.jogador, self.inimigos, self.barreiras, self.pontuacao, self.pontuacao)
